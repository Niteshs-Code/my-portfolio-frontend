    ...
    <div name="Home" className=' flex flex-col md:flex-row md:px-10 max-w-screen-2xl container mx-auto px-4 py-10'>
        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
            ...
            <div className=''>
                ...
                <span className='flex md:gap-11  md:flex-row  py-10 gap-7 md:py-4 flex-wrap text-5xl md:text-3xl pb-30 md:pb-0'>
                    <a href="" className='text-blue-500 p-2 hover:shadow-lg hover:scale-105'><FaReact /></a>
                    <a href="" className='text-green-800 p-2 hover:shadow-lg hover:scale-105'> <IoLogoNodejs /></a>
                    <a href="" className='text-green-900 p-2 hover:shadow-lg hover:scale-105'><SiMongodb /></a>
                    <a href="" className='text-blue-600 p-2 hover:shadow-lg hover:scale-105'><GrMysql /></a>
